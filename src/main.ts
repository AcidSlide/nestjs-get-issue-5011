...
async function bootstrap() {
  ...
  app.useGlobalPipes(new ValidationPipe({
    ...
    exceptionFactory: errors => new BadRequestException(errors), // added for original error layout from NestJS6, TODO might need to change this soon
  }));
  ...
  logger.debug(`Swagger Path: ${basePath}/swagger`);
